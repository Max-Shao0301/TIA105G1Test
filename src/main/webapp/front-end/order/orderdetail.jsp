...
<!-- Preloader -->
		...
		<div class="container1">
			<table class="detailtable">
				<tr>
					...
					<td>${ordersVO.status == 0 ? "已取消" : ordersVO.status == 1 ? "進行中" : ordersVO.status == 2 ? "已完成" : "未完成"}</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="clo">加購商品</td>
					<td>${ordersVO.orderCommodityVO.commodityVO.name}</td>
		...
		<div class="review-container">
			...
			<textarea class="review-input" placeholder="請寫下您的評論（最多300個字）"></textarea>
			<div class="char-count">0/300</div>
			<button class="submit-btn" disabled>提交評論</button>
